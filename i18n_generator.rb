...
require File.join(File.dirname(__FILE__), 'generators/i18n/i18n_locales_command')
require File.join(File.dirname(__FILE__), 'generators/i18n/i18n_models_command')
